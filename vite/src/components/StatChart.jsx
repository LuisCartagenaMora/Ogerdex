      ...
      <div className="stat-chart-section">
        <div className="stat-chart-box" style={{ backgroundColor: color }}>
          <div className="stat-chart-inner-box">
            ...
            <div className="total-base-stat">Total Base Stat: {calcTotal(chartDetails?.values)}</div>
            ...
            <div className="stat-chart-inner-box-bars">{chartDetails?.values.map((_, i) => {
              return <div className="individual-stat-bar" style={{ backgroundColor: barColors[i], width: 235 }}><div style={{ backgroundColor: statColors[i], width: Math.min(chartDetails?.values[i], 255) }}></div ></div >
            })}
            </div>
          </div>
        </div>
